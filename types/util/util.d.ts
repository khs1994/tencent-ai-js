export declare const URIS: {
    ...
    idcardocr: string;
    bcocr: string;
    driverlicenseocr: string;
    bizlicenseocr: string;
    creditcardocr: string;
    generalocr: string;
    plateocr: string;
    handwritingocr: string;
    detectface: string;
    detectmultiface: string;
    facecompare: string;
    detectcrossageface: string;
    faceshape: string;
    faceidentify: string;
    faceverify: string;
    newperson: string;
...
export declare const urlencode: (text: any) => string;
